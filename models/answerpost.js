...
module.exports = class answerPost extends Sequelize.Model {
  ...
  static associate(db) { //관계
    db.answerPost.belongsTo(db.User);//다:1 n:1 post.getuser(),post.adduser()사용가능
    db.answerPost.belongsTo(db.Post);
