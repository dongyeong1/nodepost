...
module.exports = class hukuokaPost extends Sequelize.Model {
  static init(sequelize) {
    return super.init({
      ...
      modelName: 'hukuokaPost',
      tableName: 'hukuokaposts',
  ...
  static associate(db) { //관계
    db.hukuokaPost.belongsTo(db.User);//다:1 n:1 post.getuser(),post.adduser()사용가능
